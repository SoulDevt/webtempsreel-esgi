...
const DatePickerForm = ({ choosenEvent, handleSubmit, handleDatePicker, handleTitle, cancel }) => {
  return (
    <form className="flex items-center w-full">
      ...
      />
      <button type="submit" className="dark:text-gray-200 hover:text-gray-400 bg-slate-800 mr-2" onClick={handleSubmit}>
        Valider
      </button>
      <button className="dark:text-gray-200 hover:text-gray-400 bg-slate-800" onClick={cancel}>
        Annuler
      </button>
    </form>
  );
